class ShafflArtView {
	...
	render(append) {
		...
		this.el.append("<div id=\"shaffl-bgblur\" ></div><center class=\"shaffl-art-view\"><div style=\"margin-top: calc(45vh - 136px)\" class=\"shaffl-loader\"></div><img id=\"shaffl-art-image\" /></center>");
